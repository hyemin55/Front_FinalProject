...
.expand-enter-active {transition: max-height 0s ease, opacity 0s ease;}
.expand-enter-to {max-height: 500px; opacity: 1;}
.expand-leave-active {transition: max-height 0s ease, opacity 0s ease;}
