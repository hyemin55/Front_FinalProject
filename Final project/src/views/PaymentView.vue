...
import PayMethod from '@/components/payment/payMethod.vue';
import PayMoney from '@/components/payment/payMoney.vue';
import PayProduct from '@/components/payment/payProduct.vue';
import PayUserInfo from '@/components/payment/payUserInfo.vue';
